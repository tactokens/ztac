...
public class Groth16Test {
    ...
    public void test() {
        ...
        byte[] proof = Base64.getDecoder().decode("");
        byte[] inputs = Base64.getDecoder().decode("LcMT3OOlkHLzJBKCKjjzzVMg+r+FVgd52LlhZPB4RFg=");
