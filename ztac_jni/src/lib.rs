...
use ztac_primitives::serialization::{read_fr_repr_be, read_fr_vec};
use ztac_primitives::verifier::{TruncatedVerifyingKey, verify_proof};
...
#[no_mangle]
pub extern "system" fn Java_com_tacplatform_ztac_bls12_Groth16_verify(env: JNIEnv,
                                             class: JClass,
                                             jvk: jbyteArray,
                                             jproof: jbyteArray,
                                             jinputs: jbyteArray)
