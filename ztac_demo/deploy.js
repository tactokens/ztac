...
const { broadcast, waitForTx, setScript, invokeScript } = require("@tac/tac-transactions");
const { address, base58Encode, publicKey } = require("@tac/tac-crypto");
const fs = require("fs");
const {extract_vk} = require("../ztac_node/lib/index.js");
...
const ridetpl = fs.readFileSync("ride/ztac.ride", {encoding:"utf8"});
