const { broadcast, waitForTx, setScript, invokeScript, nodeInteraction } = require("@tac/tac-transactions");
const { address, base58Encode, base58Decode, publicKey, privateKey } = require("@tac/tac-crypto");
const {extract_vk, MerkleTree, transfer, pubkey, fs_random, fr_random, verify, bufferizeBigints, debufferizeBigints, note_hash} = require("../ztac_node/lib/index.js");
...
const transfer_mpc = fs.readFileSync("../ztac_setup/mpc_params_transfer");
const accumulator_mpc = fs.readFileSync("../ztac_setup/mpc_params_accumulator");
